...
const Agent = () => {
  ...
  const { isLoading, isSuccess, isError, error } = useGetAgentsQuery();
  ...
  if (isError) return <p className="text-center text-red-600">Error: {error?.data?.message}</p>;
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-10">
      ...
      <div className="max-w-5xl mx-auto mt-12">
        <h2 className="text-2xl font-bold text-blue-700 mb-6 text-center">Agent List</h2>
